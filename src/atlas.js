...
// Sizes halve per LOD. Near-mirror surfaces (glass, chrome, grazing floors)
// sample LOD0/1; a large top LOD keeps their angular resolution fine enough
// that high-contrast reflected edges don't stair-step into visible teeth when
// magnified. The LOD count (not these pixel sizes) sets roughToLod, i.e. the
// blur at each roughness. Changing these dimensions requires a re-bake: the
// dim guard in main.js rejects a baked/atlas.bin whose atlas size no longer
// matches.
